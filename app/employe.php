...
<body>
    ...
    <div class="form">
        <!-- form title -->
        <div class="intro">
            <h1>Gestion d' <span>Employés</span></h1>
        </div>
    ...
    <div class="navigation">
        ...
        <form action="" method="post">
            ...
            <div class="input-group">
                <div class="input-box">
                    <input class="name" type="number" onclick="show('add1')" placeholder="Matricule" readonly>
                    <i class='bx bx-id-card'></i>
                </div>
                <div class="input-box">
                    <input class="name" type="text" onclick="show('add1')" placeholder="Prénom" readonly>
                    <i class='bx bxs-user'></i>
                </div>
                <div class="input-box">
                    <input class="name" type="text" onclick="show('add1')" placeholder="Nom" readonly>
                    <i class='bx bxs-user'></i>
                </div>
            </div>
            ...
            <div class="input-group">
                <div class="input-box">
                    <input class="name" type="text" onclick="show('add1')" placeholder="Banque" readonly>
                    <i class='bx bxs-bank'></i>
                </div>
                <div class="input-box">
                    <input class="name" type="text" onclick="show('add1')" placeholder="RIB" readonly>
            ...
            <div class="input-group">
                <div class="input-box">
                    <input type="text" class="name" onclick="show('add1')" placeholder="Grade" readonly>
