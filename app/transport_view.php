        ...
        case 'view':
            ...
            if(isset($_POST['valid'])) {
                ...
                if(!empty($num) && $count == 0) {
                    $errors['inexistant'] = "transport non trouvée";
                }
                ...
                if(empty($errors)) {
                    // get transport
                    $query = $db->prepare("select * from transport where code=?");
...
<body>
    ...
    <div class="form" style="margin-top: 60px;">
        <!-- form title -->
        <div class="intro">
            <h1>Consulter un <span>transport</span></h1>
        </div>
    ...
    <div class="navigation">
        ...
        <form action="" method="post">
            ...
            <div style="margin-bottom: 20px; margin-top: 40px;" class="input-group">
                <div class="input-box">
                    <input class="name" name="num" type="number" onkeyup="hide('hide'), hide('error')" oninput="showMsg(this.value,'6','msg2','txt'), hide_details()" value='<?php if(!empty($num)) {echo $_POST['num']; } ?>' placeholder="Code du Transport">
            ...
            <div style="margin-bottom: 20px;" class="input-group">
                <div class="input-box">
                    <input class="name" type="text" id="nom_transport" name="nom_transport" value='<?php if(!empty($nom_transport)) {echo $nom_transport; } ?>' placeholder="moyen de Transport" readonly>
...
<script>
    ...
    function hide_details() {
        document.getElementById("nom_transport").value = "";
    }
</script>
<!-- javascript end -->
