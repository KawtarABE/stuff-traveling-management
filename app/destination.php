...
<body>
    ...
    <div class="navigation">
        ...
        <form action="" method="post">
            ...
            <div class="input-group">
                <div class="input-box">
                    <input class="name" type="text" onclick="show('add1')" placeholder="Destination" readonly>
            ...
            <div class="input-group">
                <div class="input-box">
                    <input type="number" class="name" onclick="show('add1')" placeholder="distance" readonly>
