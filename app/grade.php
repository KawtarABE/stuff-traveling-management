...
<body>
    ...
    <div class="form" style="margin-top: 60px;">
        <!-- form title -->
        <div class="intro">
            <h1>Gestion des <span>Grades</span></h1>
        </div>
    ...
    <div class="navigation">
        ...
        <form action="" method="post">
            ...
            <div style="margin-bottom: 20px; margin-top: 40px;" class="input-group">
                <div class="input-box">
                    <input class="name" name="num" type="number" onclick="show('add1')" placeholder="Code" readonly>
            ...
            <div style="margin-bottom: 20px;" class="input-group">
                <div class="input-box">
                    <input class="name" type="text" onclick="show('add1')" placeholder="Grade" readonly>
